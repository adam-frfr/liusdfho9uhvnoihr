...
async function setupSchema() {
  ...
  try {
    ...
    console.log('Connected to DB. Setting up Push Notifications Schema...');
    ...
    console.log('Push Notifications Schema successfully created!');
